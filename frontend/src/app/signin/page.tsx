    ...
    <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
        <div className="sm:mx-auto sm:w-full sm:max-w-sm">
          <img
            ...
            src='https://wallpaperaccess.com/full/1112088.jpg'
            alt="HOUSE STOCK"
          />
        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            ...
            <div>
              <div className="flex items-center justify-between">
                ...
                <div className="text-sm">
                  <div onClick={() => router.push('/forgot_password')} className="cursor-pointer font-semibold text-green-400 hover:text-green-300">
                    Forgot password?
                  </div>
                </div>
              </div>
          ...
          <div className='disabled:opacity-40 flex w-full justify-center rounded-md px-3 py-1.5 text-sm font-semibold leading-6 '>
